...
class QuantumStateTomography:
    def __init__(self, u: qiskit.QuantumCircuit, vdagger: qiskit.QuantumCircuit, thetas: np.ndarray, ansatz: types.FunctionType):
        """There are four key atttributes for QST problem: u, vdagger, parameters of vdagger and name of u.
        ...
        self.trace, self.fidelity = qtm.utilities.calculate_QST_metric(
            u, vdagger, thetas)
